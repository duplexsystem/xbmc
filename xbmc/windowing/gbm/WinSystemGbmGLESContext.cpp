...
#include "cores/VideoPlayer/VideoRenderers/LibPlacebo/LinuxRendererPLGLES.h"
#endif
...
bool CWinSystemGbmGLESContext::CreateContext()
{
  ...
  for (int version : {3, 2})
  {
    ...
    {
      CLog::Log(LOGINFO, "CWinSystemGbmGLESContext: created GLES {} context", version);
      return true;
    }
  }
